...
import { Notification } from '../types/hduce';
...
const NotificationsPage: React.FC = () => {
  ...
  const notificationTypes = ['appointment', 'reminder', 'alert', 'system'];
  ...
  const getStats = () => {
    ...
    return { total, unread, read, appointments, alerts };
  };
    ...
    <div className="notifications-page">
      ...
      <div className="notifications-header">
        <div className="header-top">
          <div className="page-title">
            <h1>Notifications</h1>
            <p>Stay updated with your medical activities and alerts</p>
          </div>
          ...
          <div className="empty-notifications">
            ...
            <p>
              {notifications.length === 0
                ? "You don't have any notifications yet. They'll appear here when you have new updates."
                ...
                <div className="notification-content">
                  <div className="notification-header">
                    <h3 className="notification-title">
                      {notification?.type ? notification.type.charAt(0).toUpperCase() + notification.type.slice(1) : "Unknown"} Notification
                      <span className={`type-badge ${notification?.type || "unknown"}`}>
                  ...
                  <p className="notification-details">
                    {notification?.type === 'appointment' && 'Medical Appointment'}
        ...
        <div className="preferences-grid">
          ...
          <div className="preference-item">
            <div className="preference-info">
              ...
              <p>Important updates about your health</p>
            </div>
            <label className="toggle-switch">
              <input type="checkbox" defaultChecked />
              <span className="toggle-slider"></span>
          ...
          <div className="preference-item">
            <div className="preference-info">
              ...
              <p>Updates about HDuce platform</p>
            </div>
            <label className="toggle-switch">
              <input type="checkbox" defaultChecked />
              <span className="toggle-slider"></span>
      ...
      <div className="page-footer">
        ...
        <div className="footer-actions">
          <button onClick={fetchNotifications} className="action-btn">
            Refresh
          </button>
        </div>
      </div>
